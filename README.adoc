= Spring Webflux generic DAO implementation for using Relational Databases with Non-Blocking connections
...
This project was inspired by https://github.com/nurkiewicz/spring-data-jdbc-repository[nurkiewicz's jdbc-repository project], but has been renamed as the purpose of this project is new: providing Non-Blocking connections for Relational Databases.
